                    ...
                    >
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                value={value={cita && cita.cita && cita.tipodoc}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                onChange={actualizarState}
                                value={value={cita && cita.identificacion}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                onChange={actualizarState}
                                value={value={cita && cita.paisExpedicion}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.primerApellido}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.segundoApellido}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.primernombre}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.segundonombre}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.fechanacimineto}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.paisnacimiento}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.nacionalidad}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.paisrecidencia}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.departamentonotificacion}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.municipionotificacion}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.direccionnotififacion}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.codigopostal}
                            />
                        ...
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.accionitade}
                            />
                        </div>
                       <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={value={cita && cita.porcentajeparticipacion}
                            />
                        </div>
                    <MDBModalFooter>
                        <MDBBtn
