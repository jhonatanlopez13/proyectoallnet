                    ...
                    >
                        ...
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={citadepartamentonotificacion}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={citamunicipionotificacion}
                            />
                        </div>
                        <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={citadireccionnotififacion}
                            />
                        </div>
                        <div className="class">
                       ...
                       <div className="class">
                            ...
                            <MDBInput 
                                ...
                                placeholder="Nombre tipodoc"
                                onChange={actualizarState}
                                value={citaporcentajeparticipacion}
                            />
                        </div>
                    <MDBModalFooter>
                        <MDBBtn
