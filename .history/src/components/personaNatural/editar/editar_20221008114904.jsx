...
const Formulario = ({cita, editarCita }) => {
    ...
    const [editarcita, actualizarCita] = useState({
        ...
        paisExpedicion: {cita.paisExpedicion},
        primerApellido: {cita.primerApellido},
        segundoApellido: {cita.segundoApellido},
        primernombre:{cita.primernombre},
        segundonombre:{cita.segundonombre},
        fechanacimineto:{cita.fechanacimineto},
        paisnacimiento:{cita.paisnacimiento},
        nacionalidad:{cita.nacionalidad},
        paisrecidencia:{cita.paisrecidencia},
        departamentonotificacion:{cita.departamentonotificacion},
        municipionotificacion:{cita.municipionotificacion},
        direccionnotififacion:{cita.direccionnotififacion},
        codigopostal:{cita.codigopostal},
        email:{cita.email},
        accionitade:{cita.accionitade},
        porcentajeparticipacion:{cita.porcentajeparticipacion}
    });
